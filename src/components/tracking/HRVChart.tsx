    ...
    <div className="space-y-6 px-4">
        ...
        {autoBaseline && (
          <div className="mb-3 p-3 bg-white/50 rounded-lg">
            <div className="flex items-center justify-between">
              ...
              <div className="text-2xl font-bold text-blue-600">{autoBaseline} ms</div>
            </div>
          </div>
        )}
        ...
        <div className="p-3 bg-white/50 rounded-lg">
          <div className="flex items-center justify-between mb-2">
            <div className="flex-1">
              <div className="text-sm font-semibold text-gray-700">
                <i className="fas fa-target mr-1 text-green-600"></i>
            ...
            {baselineValue && !showBaselineInput && (
              <div className="text-2xl font-bold text-green-600 mr-4">{baselineValue} ms</div>
            )}
          </div>
        ...
        <div className="relative h-80">
          ...
          <div className="absolute left-14 right-0 top-0 bottom-8 border-l-2 border-b-2 border-gray-300">
            ...
            {autoBaseline && (
              ...
              >
                <span className="absolute right-2 -top-2 text-xs font-semibold text-blue-600 bg-white px-1">
            ...
            {baselineValue && (
              ...
              >
                <span className="absolute left-2 -top-2 text-xs font-semibold text-green-600 bg-white px-1">
          ...
          {/* X-axis labels */}
          <div className="absolute left-14 right-0 bottom-0 flex justify-between text-xs text-gray-500 pt-2">
            <span>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
        ...
        <div className="space-y-2 text-sm text-gray-700">
          ...
          {autoBaseline && (
            <div className="flex items-start gap-2 mt-4 pt-4 border-t border-purple-200">
          ...
          {baselineValue && (
            <div className="flex items-start gap-2 mt-2">
              <i className="fas fa-target text-green-600 mt-1"></i>
